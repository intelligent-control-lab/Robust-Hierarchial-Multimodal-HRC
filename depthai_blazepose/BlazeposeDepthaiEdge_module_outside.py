...
class BlazeposeDepthaiModule:
    ...
    def __init__(self, input_src="rgb",
        ...
        self.no_pos_estimate = no_pos_estimate
        ...
        # print(f"Pipelinasde started - USB speed: {str(usb_speed).split('.')[-1]}")
    ...
    def set_pipeline(self,pipeline,cam,stereo,xinframe,manager_out):
        print("Creating blazepose pipeline...")
        ...
        if self.xyz:
            print("Setting MonoCameras, Stereo and SpatialLocationCalculator nodes...")
        ...
        xinframe.out.link(pre_pd_manip.inputImage)
        ...
        xinframe.out.link(pre_lm_manip.inputImage)
        ...
        print("BlazePose pipeline created.")
